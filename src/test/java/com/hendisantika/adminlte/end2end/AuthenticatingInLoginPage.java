...
public class AuthenticatingInLoginPage extends Base {
    @Autowired
    ...
    public void user_accesses_the_login_page(String pathResource) {
//        driver.get(host+":"+port+pathResource);
        driver.get(host+pathResource);
    }
